package com.smc.customerrecordapp.ui;
...
import com.smc.customerrecordapp.datasource.Datasource;
...
public class CustomerListActivity extends FragmentActivity
    ...
    /*
    Customer list fragment instance
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //HttpRequest.getOrderListOfCustomer(getApplicationContext(), "ALFKI");
        Datasource.fetchCustomers(getApplicationContext(), new Handler(){
            @Override
            public void handleMessage(Message msg) {
                super.handleMessage(msg);
                //Log.d("Mymsg","CutomerList on UI: "+ msg.obj.toString());
                List<Customer> customers= (List<Customer>) msg.obj;

                customerListFragment = (CustomerListFragment)
                        getSupportFragmentManager().findFragmentByTag("customerList");
                customerListFragment.updateListView(customers);
            }
        }, new Handler(){
            @Override
            public void handleMessage(Message msg) {
                super.handleMessage(msg);
                Log.d("Mymsg","Servie call failure detected");
